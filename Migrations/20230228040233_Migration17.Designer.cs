...
namespace server.Migrations
{
    ...
    [Migration("20230228040233_Migration17")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Models.ChatRoom", b =>
                {
                    ...
                    b.Property<int>("ChatRoomImageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("server.Models.ChatRoomType", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ChatRoomTypeId"), 1L, 1);

                    b.Property<string>("ChatRoomTypeName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("server.Models.File", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2023, 2, 28, 10, 2, 32, 34, DateTimeKind.Local).AddTicks(2823)
                        },
                        new
                        {
                            FileId = 2,
                            ...
                            PublicationDate = new DateTime(2023, 2, 28, 10, 2, 32, 34, DateTimeKind.Local).AddTicks(2829)
                        });
                });
            ...
            modelBuilder.Entity("server.Models.GroupBlockList", b =>
                {
                    b.Property<int>("GroupBlockListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GroupBlockListId"), 1L, 1);
                    ...
                    b.Property<DateTime>("DateFrom")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 28, 10, 2, 32, 29, DateTimeKind.Local).AddTicks(4288));
            ...
            modelBuilder.Entity("server.Models.MessageAttachment", b =>
                {
            ...
            modelBuilder.Entity("server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Денис",
                            Nickname = "vecktor_21",
                            Password = "$2a$11$eBFNUCy.wCNe7cw3f0ZFHucE28AApaIByEoAgj0sG83HmFkYCch1u",
                            RegistrationDate = new DateTime(2023, 2, 28, 10, 2, 32, 288, DateTimeKind.Local).AddTicks(5381),
                            RoleId = 1,
                            Surname = "Одноуров",
                            TokenId = 1,
                            UserInfoId = 1,
            ...
            modelBuilder.Entity("server.Models.UserBlockList", b =>
                {
                    b.Property<int>("UserBlockListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserBlockListId"), 1L, 1);
                    ...
                    b.Property<DateTime>("DateFrom")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 28, 10, 2, 32, 34, DateTimeKind.Local).AddTicks(361));
            ...
            modelBuilder.Entity("server.Models.UserChatRoom", b =>
                {
                    ...
                    b.Property<int>("UserChatRoomRoleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("server.Models.UserChatRoomRole", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserChatRoomRoleId"), 1L, 1);
            ...
            modelBuilder.Entity("server.Models.UserStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserStatusId = 1,
                            StatusFrom = new DateTime(2023, 2, 28, 10, 2, 32, 34, DateTimeKind.Local).AddTicks(2864),
                            StatusName = "NORMAL"
                        });
                });
            ...
            modelBuilder.Entity("server.Models.ChatRoom", b =>
                {
                    b.HasOne("server.Models.File", "ChatRoomImage")
                        .WithMany()
                        .HasForeignKey("ChatRoomImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("server.Models.ChatRoomType", "ChatRoomType")
                        .WithMany()
                        .HasForeignKey("ChatRoomTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChatRoomImage");
            ...
            modelBuilder.Entity("server.Models.Message", b =>
                {
                    b.HasOne("server.Models.ChatRoom", "ChatRoom")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("server.Models.UserChatRoom", b =>
                {
                    ...
                    b.HasOne("server.Models.UserChatRoomRole", "UserChatRoomRole")
                        .WithMany()
                        .HasForeignKey("UserChatRoomRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
