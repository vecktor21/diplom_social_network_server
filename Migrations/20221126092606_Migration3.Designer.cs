...
namespace server.Migrations
{
    ...
    [Migration("20221126092606_Migration3")]
            ...
            modelBuilder.Entity("server.Models.BlockList", b =>
                {
                    ...
                    b.Property<DateTime>("DateFrom")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 26, 15, 26, 4, 457, DateTimeKind.Local).AddTicks(9322));
            ...
            modelBuilder.Entity("server.Models.File", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2022, 11, 26, 15, 26, 4, 499, DateTimeKind.Local).AddTicks(8204)
                        },
                        new
                        {
                            FileId = 2,
                            ...
                            PublicationDate = new DateTime(2022, 11, 26, 15, 26, 4, 499, DateTimeKind.Local).AddTicks(8283)
                        });
                });
            ...
            modelBuilder.Entity("server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Денис",
                            Nickname = "vecktor_21",
                            Password = "$2a$11$GPm8yXvFsIgYGYF2ZQai1e5DOJxK1IcKYXekjZMuivBb2wXjUZdhe",
                            RegistrationDate = new DateTime(2022, 11, 26, 15, 26, 4, 915, DateTimeKind.Local).AddTicks(1088),
                            RoleId = 1,
                            Surname = "Одноуров",
                            TokenId = 1,
                            UserInfoId = 1,
            ...
            modelBuilder.Entity("server.Models.UserStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserStatusId = 1,
                            StatusFrom = new DateTime(2022, 11, 26, 15, 26, 4, 499, DateTimeKind.Local).AddTicks(8463),
                            StatusName = "NORMAL"
                        });
                });
