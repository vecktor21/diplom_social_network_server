...
namespace server.Migrations
{
    ...
    [Migration("20221126092712_Migration5")]
            ...
            modelBuilder.Entity("server.Models.BlockList", b =>
                {
                    ...
                    b.Property<DateTime>("DateFrom")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 26, 15, 27, 10, 299, DateTimeKind.Local).AddTicks(6529));
            ...
            modelBuilder.Entity("server.Models.File", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2022, 11, 26, 15, 27, 10, 325, DateTimeKind.Local).AddTicks(3640)
                        },
                        new
                        {
                            FileId = 2,
                            ...
                            PublicationDate = new DateTime(2022, 11, 26, 15, 27, 10, 325, DateTimeKind.Local).AddTicks(3658)
                        });
                });
            ...
            modelBuilder.Entity("server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Денис",
                            Nickname = "vecktor_21",
                            Password = "$2a$11$JMA0puGKaACvcKAr4byMaeJ/32wMMlwTtCtPvbyXKCmIldeIP3gxi",
                            RegistrationDate = new DateTime(2022, 11, 26, 15, 27, 10, 630, DateTimeKind.Local).AddTicks(2362),
                            RoleId = 1,
                            Surname = "Одноуров",
                            TokenId = 1,
                            UserInfoId = 1,
            ...
            modelBuilder.Entity("server.Models.UserStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserStatusId = 1,
                            StatusFrom = new DateTime(2022, 11, 26, 15, 27, 10, 325, DateTimeKind.Local).AddTicks(3737),
                            StatusName = "NORMAL"
                        });
                });
