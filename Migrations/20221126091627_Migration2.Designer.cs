...
namespace server.Migrations
{
    ...
    [Migration("20221126091627_Migration2")]
            ...
            modelBuilder.Entity("server.Models.BlockList", b =>
                {
                    ...
                    b.Property<DateTime>("DateFrom")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 26, 15, 16, 25, 853, DateTimeKind.Local).AddTicks(9068));
            ...
            modelBuilder.Entity("server.Models.File", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2022, 11, 26, 15, 16, 25, 879, DateTimeKind.Local).AddTicks(5538)
                        },
                        new
                        {
                            FileId = 2,
                            ...
                            PublicationDate = new DateTime(2022, 11, 26, 15, 16, 25, 879, DateTimeKind.Local).AddTicks(5555)
                        });
                });
            ...
            modelBuilder.Entity("server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Денис",
                            Nickname = "vecktor_21",
                            Password = "$2a$11$bKFKtqKuUmw3S8M33QkpU.0Im63bPQpQqtHNf12fOS3zssX.BozMC",
                            RegistrationDate = new DateTime(2022, 11, 26, 15, 16, 26, 228, DateTimeKind.Local).AddTicks(1681),
                            RoleId = 1,
                            Surname = "Одноуров",
                            TokenId = 1,
                            UserInfoId = 1,
            ...
            modelBuilder.Entity("server.Models.UserStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserStatusId = 1,
                            StatusFrom = new DateTime(2022, 11, 26, 15, 16, 25, 879, DateTimeKind.Local).AddTicks(5646),
                            StatusName = "NORMAL"
                        });
                });
