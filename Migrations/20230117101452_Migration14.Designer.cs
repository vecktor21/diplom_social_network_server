...
namespace server.Migrations
{
    ...
    [Migration("20230117101452_Migration14")]
            ...
            modelBuilder.Entity("server.Models.ChatRoom", b =>
                {
                    ...
                    b.Property<int>("ChatRoomImageFileId")
                        .HasColumnType("int");

                    b.Property<string>("ChatRoomImageId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ChatRoomImageFileId");
            ...
            modelBuilder.Entity("server.Models.ChatRoom", b =>
                {
                    b.HasOne("server.Models.File", "ChatRoomImage")
                        .WithMany()
                        .HasForeignKey("ChatRoomImageFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
